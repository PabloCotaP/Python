...
def create_nodes(nodes):
    for node_y in range(100, 701, 150):
            for node_x in range(300, 901, 150):
                node_start = True if (node_x, node_y) in [(300, 100), (300, 250), (450, 250), (900, 400), (300, 700)] else False # Definir qué nodos son iniciales
                #Da valor y color a los nodos iniciales
                if node_x == 300 and node_y == 100:
                    node_color = cian
                    node_value = 5
                    node_end_value = 30
                elif node_x == 300 and node_y == 250:
                    node_color = pink
                    node_value = 7
                    node_end_value = 28
                elif node_x == 450 and node_y == 250:
                    node_color = orange
                    node_value = 8
                    node_end_value = 480
                ...
                #Da valor a algunos nodos
                    ...
                    node_value = 3
                elif node_x == 450 and node_y == 400:
                    node_value = 4
                elif node_x == 900 and node_y == 250:
                    node_value = 4
                elif node_x == 900 and node_y == 700:
                    node_value = 5
                elif node_x == 300 and node_y == 550:
                    node_value = 2
                elif node_x == 600 and node_y == 100:
                    node_value = 2
                elif node_x == 600 and node_y == 400:
                    node_value = 3
                elif node_x == 750 and node_y == 250:
                    node_value = 5
                elif node_x == 750 and node_y == 550:
                    node_value = 3
                elif node_x == 600 and node_y == 550:
                    node_value = 8
                else:
                    node_value = 1
                if node_start == True:
...
def lvl3():
    ...
    other_node = None
    drawing = False
    lvl_img = pg.image.load(r"D:\Proyectos Python\Lenguaje Python UABC\Juego\lvl3.png").convert()
    ...
    while True:
                                ...
                                if distance_to_final_node <= 175:
                                    if not node.unlock:  # Verificar si el nodo está bloqueado
                                        ...
                                        if other_node.value != 0:
                                            node.value = other_node.value * node.value
                                        else:
                            ...
                            for line in connected_lines:
                                ...
                                for other_node in nodes:
                                    if (other_node.x, other_node.y) == other_end and not other_node.unlock:
                                        ...
                                        if node.value !=0:
                                            other_node.value = int(node.value / node.og_value)
                                        else:
        ...
        if drawing and other_node is not None:
            ...
            if current_pos[0] >= max_x_lim and distance <= 175:
