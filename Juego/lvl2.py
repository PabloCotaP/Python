...
def create_nodes(nodes):
    for node_y in range(100, 701, 200):
            for node_x in range(300, 901, 200):
                node_start = True if (node_x, node_y) in [(300, 300), (300, 500), (900, 700), (500, 500)] else False # Definir qué nodos son iniciales
                #Da valor y color a los nodos iniciales
                if node_x == 300 and node_y == 300:
                    node_color = cian
                    node_value = 85
                    node_end_value = 47
                elif node_x == 300 and node_y == 500:
                    node_color = pink
                    node_value = 60
                    node_end_value = 15
                    ...
                    node_value = 56
                    node_end_value = 6
                elif node_x == 500 and node_y == 500:
                    node_color = purple
                    node_value = 79
                    node_end_value = 74
...
def lvl2():
    ...
    other_node = None
    drawing = False
    lvl_img = pg.image.load(r"D:\Proyectos Python\Lenguaje Python UABC\Juego\lvl2.png").convert()
                            ...
                            if distance <= node.radius and node != other_node and node.color == grey:  # Verificar si se ha soltado en otro nodo
                                ...
                                if distance_to_final_node <= 225:
                                    if not node.unlock:  # Verificar si el nodo está bloqueado
                                        ...
                                        #Resta los valores, el orden se determina en base a cual es mayor
                            ...
                            for line in connected_lines:
                                ...
                                for other_node in nodes:
                                    if (other_node.x, other_node.y) == other_end and not other_node.unlock:
                                        ...
                                        #Other_node es el que pasara a tener el valor sumado
                                        if node.value > node.og_value:
                                            other_node.value = node.value + node.og_value
                                        else:
                                            other_node.value = node.og_value - node.value
